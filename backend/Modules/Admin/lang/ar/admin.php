...
return [
    "buttons" => [
        ...
        "print_receipt_and_close" => "طباعة الإيصال وإغلاق",
        "export" => "تصدير",
        "back" => "رجوع",
        "actions" => "الإجراءات",
        "print" => "طباعة",
    ...
    "table" => [
        ...
        "showing_from_to_of_total_entries" => "عرض من {from} إلى {to} من أصل {total} إدخالات",
        "show" => "عرض",
        "entries" => "إدخالات",
        "actions" => "الإجراءات",
        "yes" => "نعم",
        "no" => "لا",
        "from_desktop" => "من الحاسوب",
        "platform" => "المنصة",
        "browser" => "المتصفح",
        "user" => 'المستخدم',
        ...
        "number_records_selected" => "تم تحديد {number} سجل(ات)",
    ...
    "configuracion_landing" => [
        "cards" => [
            ...
            "plano_de_mesas" => [
                ...
                "subtitle" => "المخطط البصري للصالة، المناطق",
            ],
            "operacion" => [
                "title" => "العمليات",
                "subtitle" => "طرق الدفع والقنوات والطباعة وشاشة المطبخ",
            ],
            "users_and_security" => [

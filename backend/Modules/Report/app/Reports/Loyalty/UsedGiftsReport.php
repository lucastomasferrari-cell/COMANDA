...
class UsedGiftsReport extends LoyaltyReport
{
    /** @inheritDoc */
    ...
    public function columns(): array
    {
        return [
            ...
            "loyalty_gifts.used_at as used_date",
        ];
    }
    ...
    public function resource(Model $model): array
    {
        return [
            ...
            "used_date" => dateTimeFormat(Carbon::parse($model->used_date)),
        ];
    }
    ...
    public function through(Request $request): array
    {
        return [
            fn(Builder $query, Closure $next) => $next($query)
                ...
                ->where('loyalty_gifts.status', LoyaltyGiftStatus::Used)

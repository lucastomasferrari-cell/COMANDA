...
class TotalRedeemedPointsReport extends LoyaltyReport
{
    /** @inheritDoc */
    public function key(): string
    {
        return "loyalty_total_redeemed_points";
    }
    ...
    public function columns(): array
    {
        return [
            ...
            "COALESCE(SUM(loyalty_transactions.points), 0) as total_redeemed_points",
        ];
    }
    ...
    public function through(Request $request): array
    {
        ...
        return [
            fn(Builder $query, Closure $next) => $next($query)
                ...
                ->where('loyalty_transactions.type', LoyaltyTransactionType::Redeem->value)

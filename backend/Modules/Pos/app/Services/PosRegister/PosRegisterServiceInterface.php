...
interface PosRegisterServiceInterface
{
    /**
     ...
     *
     * @param int $id
     * @return PosRegister|Builder|EloquentCollection|array;
     * @throws ModelNotFoundException
     */
    public function findOrFail(int $id): PosRegister|Builder|EloquentCollection|array;

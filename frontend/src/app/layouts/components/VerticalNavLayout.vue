<script lang="ts">
  ...
  import VerticalNav from '@/app/layouts/components/VerticalNav.vue'
      ...
      return () => {
        ...
        const navbar = h(
          'header',
          {
            class: [
              ...
              route.meta.hiddenTopHeader ? 'd-none' : '',
            ],
          },
          [
            h(
        ...
        return h(
          ...
          [
            ...
            h(
              'div',
              { class: ['layout-content-wrapper', route.meta.hiddenSidebar ? 'padding-inline-start-none' : ''] },
              [
                navbar,
                main,
                footer,
...
@use "@/assets/scss/layouts/styles/placeholders";

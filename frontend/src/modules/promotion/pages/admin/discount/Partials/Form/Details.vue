    ...
    <VCard>
      <VCardTitle class="d-flex justify-space-between align-center mb-2">
        <div class="d-flex align-center">
          ...
          <span>{{ t('discount::discounts.form.cards.details') }}</span>
        </div>
      </VCardTitle>
      <VCardText>
        <VRow>
          <VCol cols="12" md="4">
            <VSelect
              ...
              item-value="id"
              :items="meta.types"
              :label="t('discount::attributes.discounts.type')"
            />
          </VCol>
          <VCol cols="12" md="4">
            <VTextField
              ...
              :label="t('discount::attributes.discounts.value')"
          ...
          <VCol v-if="form.state.type !='fixed'" cols="12" md="4">
            <VTextField
              ...
              :label="t('discount::attributes.discounts.max_discount')"
              :prefix="currency"
            />
          </VCol>
          <VCol cols="12" md="6">
            <VTextField
              ...
              :label="t('discount::attributes.discounts.minimum_spend')"
              :prefix="currency"
            />
          </VCol>
          <VCol cols="12" md="6">
            <VTextField
              ...
              :label="t('discount::attributes.discounts.maximum_spend')"
              :prefix="currency"
            />
          </VCol>
        </VRow>

<script lang="ts" setup>
  ...
  const headers: TableHeader[] = [
    { title: t('discount::discounts.table.name'), value: 'name', sortable: true },
    {
    ...
    { title: t('discount::discounts.table.type'), value: 'type', sortable: true },
    {
      title: t('discount::discounts.table.value_text'),
      value: 'value_text',
      sortable_key: 'value',
      sortable: true,
    },
    { title: t('discount::discounts.table.used'), value: 'used', sortable: true },

<script lang="ts" setup>
  ...
  const headers: TableHeader[] = [
    { title: t('menu::menus.table.name'), value: 'name', sortable: true },
    {
  ...
  const actions: TableAction[] = [
    {
      ...
      color: 'info',
      label: t('category::categories.categories'),
      onClick: item => {
        router.push({ name: 'admin.menus.categories', params: { id: item.id } } as unknown as RouteLocationRaw)
      },
    },
    {
      key: 'products',
      ...
      color: 'secondary',
      label: t('product::products.products'),
      onClick: item => {
        router.push({ name: 'admin.menus.products.index', params: { menuId: item.id } } as unknown as RouteLocationRaw)
      },
    },
    { key: 'edit' },
    {

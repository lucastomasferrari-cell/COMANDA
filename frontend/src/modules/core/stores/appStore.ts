...
export const useAppStore = defineStore('app', {
  state: (): AppState => ({
    settings: {
      ...
      // Paleta coral marca — mismos valores que theme.ts. Estos defaults se
      // usan si el backend no devuelve settings custom; se reemplazan vía
      // setSettings() al recibir los de verdad.
